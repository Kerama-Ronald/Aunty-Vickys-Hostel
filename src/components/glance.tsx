        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex overflow-hidden flex-col items-center justify-center space-y-4">
            <img
              ...
              width="400"
              height="300"
              className="glc h-[300px] w-full rounded-lg object-cover object-center"
              style={{ aspectRatio: "400 / 300", objectFit: "cover" }}
            />
            <h3 className="text-xl font-semibold">Cozy Dorm Rooms</h3>
            <p className="text-gray-500 dark:text-gray-400">
              Our dorm rooms offer a comfortable and affordable option for solo
              travelers or groups.
            </p>
          </div>
          <div className="flex overflow-hidden flex-col items-center justify-center space-y-4">
          ...
          <div className="flex overflow-hidden flex-col items-center justify-center space-y-4">
            <img
              ...
              style={{ aspectRatio: "400 / 300", objectFit: "cover" }}
            />
            <h3 className="text-xl font-semibold">Family-Friendly Suites</h3>
            <p className="text-gray-500 dark:text-gray-400">
